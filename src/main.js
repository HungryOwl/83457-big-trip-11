      ...
      <form class="trip-events__item  event  event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="Mordor" list="destination-list-1">
...
const renderTrips = (tripsCount) => {
  ...
  Array(tripsCount).fill(``).forEach(() => {
    renderTemplate(tripListElement, tripPointTemplate());
  });
};

renderTemplates(
    {container: `.trip-controls h2`, render: menuTemplate, place: `afterEnd`},
    {container: `.trip-controls h2~h2`, render: filterTemplate, place: `afterEnd`},
    {container: `.trip-main`, render: tripInfoTemplate, place: `afterBegin`},
    {container: `.trip-info`, render: tripInfoCost},
    {container: `.trip-events`, render: sortTemplate},
    {container: `.trip-events`, render: tripEditTemplate},
    {container: `.trip-events`, render: tripDaysTemplate}
);
